...
export const SPECIALISTS: { id: SpecialistId; label: string; color: string; angle: number }[] = [
  { id: 'notes-specialist', label: 'NOTES', color: 'var(--hud-violet)', angle: -120 },
  { id: 'calendar-specialist', label: 'CALENDAR', color: 'var(--hud-amber)', angle: 0 },
  { id: 'followups-specialist', label: 'FOLLOW-UPS', color: 'var(--hud-green)', angle: 120 }
];
